...
**Author:** [Michael Kazembe](https://github.com/MichaelKazembe/) <michaelkazembe@gmail.com >
...
- if
  ...
  is not an integer or if there is no argument given to
...
![img](http://mein-fun.com/data/media/5/brainfuck_bean.jpg)
